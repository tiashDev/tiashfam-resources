...
callMode(lang, text, theme, extract) {
    ...
    newLang.createExtract = function({ str, start, end, callback, repl = "" }) {
...
syntaxHighlight({ elmnt, mode, theme = morsel.defaultTheme }) {
  ...
  var attributecolor = theme.attributecolor;
  var attributevaluecolor = theme.attributevaluecolor;
  var commentcolor = theme.commentcolor;
  var cssselectorcolor = theme.cssselectorcolor;
  var csspropertycolor = theme.csspropertycolor;
  var csspropertyvaluecolor = theme.csspropertyvaluecolor;
  var cssdelimitercolor = theme.cssdelimitercolor;
  var cssimportantcolor = theme.cssimportantcolor;  
  var jscolor = theme.jscolor;
  var jskeywordcolor = theme.jskeywordcolor;
  var jsstringcolor = theme.jsstringcolor;
  ...
  function cssImportantMode(txt) {
    return "<span style='color:" + cssimportantcolor + ";font-style: italic;'>" + txt + "</span>";
  }
  function jsMode(txt) {
